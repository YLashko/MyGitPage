<template>
    ...
    <info-box :noHoverAnim="true">
        ...
        <p>All data for the page were collected from fandom wiki and packed directly as .InnerHTML string in JSON and also downloaded pictures, using mix of selenium and requests. The scraper works by iterating over possible table objects and checking to see if it's a table, since this site may have ads in random places in the same element, so simple hard-coded XPath scraping won't work.</p>
        <pre class="code">
for i in range(4, 15):
