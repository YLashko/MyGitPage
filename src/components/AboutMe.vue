<template>
    <info-box :title="'About me'" :noHoverAnim="true">
        <p>Hello! My name is Yahor Lashko, i'm 20 years old student at Cracow University of Economics. A recently finished my bachelors in Applied Informatics at Cracow University of Economics. I moved from Belarus to Poland in 2020 to study and have been living in Cracow ever since, only returning to my family in Belarus during summer vacations. My family moved here summer 2023 and we are planning to live in Poland from now on.</p>
        <p>I have the most experience in backend and fullstack development using Python+Django/Flask, Java+Spring, as well as relational databases (MSSQL, SQLite), but also know the basics of data science with Pandas + Torch, Linux/Windows administration and docker (the university had a fairly wide profile of courses, in each course I tried to do something extra besides the program). In the projects tab you can find what I think are my most interesting projects.</p>
