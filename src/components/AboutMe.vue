<template>
    <info-box :title="'About me'" :noHoverAnim="true">
        ...
        <p>I have the most experience in backend and fullstack development, as well as relational databases, but also know the basics of data science, Linux/Windows administration and docker (the university had a fairly wide profile of courses, in each course I tried to do something extra besides the program). In the projects tab you can find what I think are my most interesting projects.</p>
